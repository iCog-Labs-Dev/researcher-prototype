...
- Citation Style: {citation_style} (inline/numbered/bibliography)
...
- Only if the conversation requires it, provide 1-2 relevant follow-up questions, phrased as if the user is asking them.
