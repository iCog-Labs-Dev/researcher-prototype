        ...
        try:
            ...
            for ts in topic_scores:
                ...
                logger.debug(
                    ...
                    f"     \n"
                    f"     ━━━ SCORE BREAKDOWN ━━━\n"
                    f"     staleness_pressure:    {staleness_pressure:.5f} (stored)\n"
                    f"       Formula: time_elapsed * coefficient * scale\n"
                    f"       Values:  {seconds_ago:.2f}s * {staleness_coefficient} * {self._config.staleness_scale}\n"
                    f"       Calc:    {seconds_ago * staleness_coefficient * self._config.staleness_scale:.5f} (current)\n"
