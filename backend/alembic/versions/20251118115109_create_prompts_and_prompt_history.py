...
def upgrade() -> None:
    ...
    SEED = {
        "MULTI_SOURCE_SYSTEM_PROMPT": {
            "category": "Other",
            "description": "Analyzes user queries to determine optimal approach and sources",
...
{memory_context_section}""",
        ...
        "SEARCH_OPTIMIZER_SYSTEM_PROMPT": {
            "category": "Search",
            "description": "Optimizes user questions into effective search queries",
            "content": """Current date and time: {current_time}
...
{memory_context_section}""",
        ...
        "ANALYSIS_REFINER_SYSTEM_PROMPT": {
            "category": "Analysis",
            "description": "Refines user requests into structured analytical tasks",
            "content": """Current date and time: {current_time}
...
{memory_context_section}""",
        ...
        "PERPLEXITY_SYSTEM_PROMPT": {
            "category": "Search",
            "description": "System prompt for web search functionality",
            "content": """Current date and time: {current_time}. 
...
Provide clear, factual answers while acknowledging any limitations in the available information.""",
        ...
        "INTEGRATOR_SYSTEM_PROMPT": {
            "category": "Integrator",
            "description": "Integrates information from multiple sources into coherent responses",
            "content": """Current date and time: {current_time}.
...
Your response should be a clear synthesis with ALL original citation markers preserved exactly where they support the information. Do NOT include a separate "Sources" section at the end.""",
        ...
        "EVIDENCE_SUMMARIZER_PROMPT": {
            "category": "Other",
            "description": "System prompt for evidence summarizer prompt",
            "content": """Current date and time: {current_time}
...
{{
    "summary_text": "Recent studies show promising results for new treatment approaches[0]. However, some researchers note potential side effects that require further investigation[1][2]. The methodology used in these studies has been validated across multiple institutions[0]."
        ...
        "SEARCH_RESULTS_REVIEWER_PROMPT": {
            "category": "Search",
            "description": "System prompt for search results reviewer prompt",
            "content": """Current date and time: {current_time}
...
{{"selected_indices": [], "reason": "no highly relevant items"}}""",
        ...
        "RESPONSE_RENDERER_SYSTEM_PROMPT": {
            "category": "Response",
            "description": "Formats and styles responses according to user preferences",
            "content": """Current date and time: {current_time}
...
The raw response was generated by the {module_used} module of the assistant.""",
        ...
        "RESEARCH_QUERY_GENERATION_PROMPT": {
            "category": "Research",
            "description": "Generates optimized queries for autonomous research",
            "content": """Current date and time: {current_time}.
...
Generate a single, well-crafted research query that will effectively find new and relevant information about this topic.""",
        ...
        "RESEARCH_SOURCE_SELECTION_PROMPT": {
            "category": "Research",
            "description": "System prompt for research source selection prompt",
            "content": """You are an expert research coordinator selecting the best information sources for autonomous research.
...
Focus on sources that will provide the most comprehensive and up-to-date information for autonomous research.""",
        ...
        "RESEARCH_FINDINGS_QUALITY_ASSESSMENT_PROMPT": {
            "category": "Research",
            "description": "Assesses quality of research findings",
            "content": """Current date and time: {current_time}.
...
Focus on providing accurate assessments that will help determine if these findings are worth storing for the user.""",
        ...
        "RESEARCH_FINDINGS_DEDUPLICATION_PROMPT": {
            "category": "Research",
            "description": "System prompt for research findings deduplication prompt",
            "content": """Current date and time: {current_time}.
...
Always err on the side of keeping findings unless they are very clearly duplicates.""",
        ...
        "TOPIC_EXTRACTOR_SYSTEM_PROMPT": {
            ...
            "description": "Extracts research-worthy topics from conversations",
            "content": """Current date and time: {current_time}.
...
REMEMBER: The user's LATEST MESSAGE is the primary source. Use research interests only to suggest more sophisticated angles on the current topic.""",
        ...
        "ADJACENT_TOPIC_SELECTOR_PROMPT": {
            "category": "Topic Extraction",
            "description": "System prompt for adjacent topic selector prompt",
            "content": """Current date and time: {current_time}.
...
{{
  "topics": [
    ...
    for name, meta in SEED.items():
        ...
        variables = sorted({field for _, field, _, _ in Formatter().parse(content) if field})
        rows.append({
            "name": name,
    ...
    op.bulk_insert(prompts_tbl, rows)
